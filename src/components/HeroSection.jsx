...
export const HeroSection = () => {
  return (
    <section id="inicio" className="relative min-h-screen flex items-center justify-center px-6 lg:px-20">
      ...
      {/* Contenido */}
      <div className="relative z-10 container mx-auto max-w-4xl text-center space-y-6 text-white">
        <h1 className="text-4xl md:text-6xl font-bold tracking-tight">
          ...
          <span className="ml-2 opacity-0 animate-fade-in-delay-2"> Vanegas</span>
        </h1>
        <p className="text-lg md:text-xl max-w-2xl mx-auto opacity-0 animate-fade-in-delay-3 text-white/90">
